...
/**
 * Test for /transactiontest/{transactionId}/{campaignId}
 */
Test('/transactiontest/{transactionId}/{campaignId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test transactiontest get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/transactiontest/{transactionId}/{campaignId}']['get']['responses']['200']['schema']);
